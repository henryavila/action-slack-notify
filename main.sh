...
export SLACK_TITLE=${SLACK_TITLE:-$GITHUB_REPOSITORY}
export BUILD_STATUS=${BUILD_STATUS:-"SUCCESS"}
...
if [[ -z "$SLACK_MESSAGE" ]]; then
	export SLACK_MESSAGE="$GITHUB_REPOSITORY@$GITHUB_BRANCH $BUILD_STATUS: $COMMIT_MESSAGE"
fi
